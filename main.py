#!/usr/bin/env python3
"""
ESX/QB-Core Converter - A tool to convert FiveM scripts between ESX and QB-Core frameworks.
"""
import sys
import os
...
from src.core.patterns import load_conversion_patterns
    ...
    def _setup_ui(self):
        ...
        with ui.column().classes("w-full max-w-3xl mx-auto p-4 gap-4"):
            ...
            with ui.card().classes("w-full p-4 shadow-md"):
                ui.label(
                    "Convert FiveM scripts between ESX and QB-Core frameworks"
                ).classes("text-lg")
                ui.markdown(
                    """
            ...
            self.action_buttons = ActionButtons(
                convert_callback=self._convert, quit_callback=self._quit
            )

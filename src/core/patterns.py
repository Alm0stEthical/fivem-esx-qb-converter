...
QB_TO_ESX = [
    ("local QBCore = exports['qb-core']:GetCoreObject()", "local ESX = exports['es_extended']:getSharedObject()"),
    ...
    ("QBCore:Notify", "esx:showNotification"),
]

PATTERNS = {
    "ESX to QB-Core": ESX_TO_QB,
    "QB-Core to ESX": QB_TO_ESX,
}
